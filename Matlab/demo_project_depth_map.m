...
LABELED_DATASET_PATH = 'nyu_depth_v2_labeled.mat';

load(LABELED_DATASET_PATH, 'rawDepthFilenames', 'rawRgbFilenames');

%% Load a pair of frames and align them.
imgRgb = imread(sprintf('%s/%s', CLIPS_DIR, rawRgbFilenames{120}));

imgDepth = imread(sprintf('%s/%s', CLIPS_DIR, rawDepthFilenames{120}));
